...
# ── main area ────────────────────────────────────────────────────────────
st.title("🌾 French Barley Supply‑Chain Risk Monitor")
st.caption(
    ...
    with ac2:
        if "Q1" in quadrant_name:
            ...
            st.markdown(
                """
**🌍 ESG & Farmer Support:**
- Launch **Regenerative Agriculture (RegenAg)** pilots — subsidise cover crops to retain soil moisture.
...
- Invest in **Transition Finance** — link loan conditions to adoption of climate-resilient practices.

**👨‍🌾 Farmer Empowerment:**
- Provide **drought-resistant seed varieties** at subsidised prices.
- Offer **premium buy-back** for farmers adopting water-conserving RegenAg practices (verified via LCA data).
"""
            )
...
- Increase **long-term contract share** in this region to lock in stable supply.
- Evaluate relocating **primary processing or core warehousing** closer to this region.

**🌍 ESG & Carbon:**
- Prioritise collecting **Primary Data** (replace Agribalyse industry averages) for more accurate carbon footprint accounting.
- Introduce **Carbon Insetting** — reward farmers who maintain strong soil carbon sequestration with additional income via carbon credits.

**👨‍🌾 Farmer Empowerment:**
- Incentivise best practices via **performance bonuses** linked to yield and sustainability KPIs.
"""
            )
            ...
            st.markdown(
                """
**🛒 Procurement & R&D:**
- Activate **Dual Sourcing** — identify alternative supply regions to reduce dependency.
- Work with R&D to test **recipe or feedstock substitution** (e.g., alternative starch sources).

**🌍 ESG & Social Responsibility:**
- Farmers here face **abandonment risk** — a social responsibility concern.
- Provide **early climate warning** services and advise farmers on switching to more drought-tolerant crops for the next season.
...
"""
            ...
            st.markdown(
                """
**📋 Compliance & ESG:**
- Maintain **routine audits** and baseline monitoring.
- Use **industry-average secondary data** (e.g., Agribalyse) — no need for costly primary data collection given low materiality.

**👨‍🌾 Farmer Empowerment:**
- Provide **digital agronomy training** and basic sustainability toolkits.
- Require suppliers to sign **Code of Conduct** including no-deforestation commitments.
"""
            )
...
- **CO₂e** fixed at {EF_HA:,} kg CO₂e / ha
